...
<ul>
	<li>it has an area of at least&nbsp;three million (i.e., <code data-copier-init="true">3000000 km<sup>2</sup></code>), or</li>
	<li>it has a population of at least&nbsp;twenty-five million (i.e., <code data-copier-init="true">25000000</code>).</li>
</ul>
